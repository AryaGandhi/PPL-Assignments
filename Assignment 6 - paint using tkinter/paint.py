...
class Paint(object):
    ...
    def __init__(self):
        ...
        self.photo_circle = PhotoImage(file=r"circle.png")
        self.photo_image_circle = self.photo_circle.subsample(5, 5)
        ...
        self.photo_circle_filled = PhotoImage(file=r"circle_filled.png")
        self.photo_image_circle_filled = self.photo_circle_filled.subsample(5, 5)
        ...
        self.photo_rectangle = PhotoImage(file=r"rectangle.png")
        self.photo_image_rectangle = self.photo_rectangle.subsample(5, 5)
        ...
        self.photo_rectangle_filled = PhotoImage(file=r"rectangle_filled.png")
        self.photo_image_rectangle_filled = self.photo_rectangle_filled.subsample(5, 5)
        ...
        self.photo_arc = PhotoImage(file=r"arc.png")
        self.photo_image_arc = self.photo_arc.subsample(5, 5)

        self.arc_button = Button(self.root, image=self.photo_image_arc, command=self.draw_arc)
        self.arc_button.grid(row=1, column=4)

        self.photo_arc_filled = PhotoImage(file=r"arc_filled.png")
        self.photo_arc_circle_filled = self.photo_arc_filled.subsample(5, 5)
        ...
        self.photo_line = PhotoImage(file=r"line.png")
        self.photo_image_line = self.photo_line.subsample(5, 5)

        self.line_button = Button(self.root, image=self.photo_image_line, command=self.draw_line)
        self.line_button.grid(row=1, column=6)

        self.photo_arrow = PhotoImage(file=r"arrow.png")
        self.photo_image_arrow = self.photo_arrow.subsample(5, 5)
        ...
        self.photo_dashed_line = PhotoImage(file=r"dashed_line.png")
        self.photo_image_dashed_line = self.photo_dashed_line.subsample(5, 5)
